...
public class GaleaHelmetRenderer implements ArmorRenderer {
    /*@Override
...
//        PlumeModel plumeModel = new PlumeModel(MinecraftClient.getInstance().getEntityModelLoader().getModelPart(GladiatorsRebornClient.GALEA_PLUME_LAYER));
//        plumeModel.render(matrices, vertexConsumerProvider.getBuffer(RenderLayer.getEntityTranslucent(GladiatorsReborn.id("textures/plumes/red_plume.png"))), light, OverlayTexture.DEFAULT_UV, 1, 1, 1, 1);
